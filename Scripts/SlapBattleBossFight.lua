...
if game.PlaceId ~= 18550498098 then
	...
	Notify({Description = "到Boss戰地方在開" ; Title = "錯誤!"; Duration = 5;});
	return
end

Notify({Description = "腳本執行!" ; Title = "腳本執行!"; Duration = 5;});
...
MainUi.BackgroundColor3 = Color3.new(0.670588, 0.850980, 1)
--MainUi.TextScaled = true
MainUi.Active = true
MainUi.Draggable = true

local Title = Instance.new("TextLabel", MainUi)
Title.Size = UDim2.new(1, 0, 0.1, 0)
Title.BackgroundColor3 = Color3.new(0.670588, 0.850980, 1)
Title.Text = "Boss戰"
...
TPTo.BackgroundColor3 = Color3.new(0.478431, 1, 0.784313)
TPTo.Text = "傳送到開關房"
...
SAFE.BackgroundColor3 = Color3.new(0.478431, 1, 0.784313)
SAFE.Text = "傳送到安全區"
TPTo.TextScaled = true
...
HITMINI.BackgroundColor3 = Color3.new(0.478431, 1, 0.784313)
HITMINI.Text = "自動打小怪"
...
HITGOLEM.BackgroundColor3 = Color3.new(0.478431, 1, 0.784313)
HITGOLEM.Text = "自動打石像"
...
HITGUIDE.BackgroundColor3 = Color3.new(0.478431, 1, 0.784313)
HITGUIDE.Text = "自動打Boss"
...
HITROCKET.BackgroundColor3 = Color3.new(0.478431, 1, 0.784313)
HITROCKET.Text = "自動打火箭"
...
SPARE.BackgroundColor3 = Color3.new(0.478431, 1, 0.784313)
...
UNSPARE.BackgroundColor3 = Color3.new(0.478431, 1, 0.784313)
UNSPARE.TextScaled = true
UNSPARE.Text = "不要救 (Hunter)"
...
ExtraFrame.BackgroundColor3 = Color3.new(0.670588, 0.850980, 1)
...
local CLOSE = Instance.new("TextButton", MainUi)
